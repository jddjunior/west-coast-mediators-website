    ...
    sections: [
      {
        id: 'family',
        label: 'Family',
        items: ['Third-generation Tampa native', 'Additional family details are not provided in the available biography.'],
      },
      {
        id: 'education',
        label: 'Education',
      ...
      },
      {
        ...
        label: 'Employment',
        items: [
          'Civil trial practice for more than 29 years',
          'Represents both Plaintiffs and Defendants in civil trial matters',
          'Practice areas include personal injury, products liability, premises liability, trucking accidents, brain injury, medical malpractice, and business litigation',
          'Specific employer history is not provided in the available biography.',
        ],
      },
    ],
  },
